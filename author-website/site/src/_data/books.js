// The catalogue, as data. Adding a title later is an entry here — no redesign.
// status: "available" | "preorder" | "forthcoming"
// Covers/buy links are placeholders until assets exist (spec §9.11).

export default {
  // ── The Trilogy ──────────────────────────────────────────────────────────
  // Reading order and publication order differ; both are shown on the site.
  trilogy: {

# works/ — Compositions (Work Profile layer)

One folder per composition. Each holds everything specific to that
composition: deep dives, narration arcs, architecture, drafts, audits,
registers, and its writing system / voice palette.

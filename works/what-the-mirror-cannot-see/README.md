...
**Title note:** the source file was named `WhatTheMirrorDoesNotSee_v9.docx`, and the manuscript's own title page and subtitle still read *"What the Mirror Does Not See."* Canonical title, per Kenneth (2026-06-20): **What the Mirror Cannot See.** The manuscript's title page needs reconciling to match — pending authorization.
